...
<!--sub-Header MENU-->
        ...
        <div class="space-between vertica-align-flex padding-5" style="background: rgba(58,83,106,0.5)">
            <div class="space-between vertica-align-flex" style="width: 100%">
                ...
                <a href="${pageContext.request.contextPath}/add_collection.jsp" class="margin-left home_menu a homeLink" >
                    <span class="capitalize bold" >add new collection</span>&nbsp;&nbsp;&nbsp;<i class="icon bg-blue" style="padding: 2px"></i>
                </a>
            </div>
        </div> 
